...
class StarlarkRuleValidatorTest {

    private StarlarkRuleValidator validator;

    @BeforeEach
    void setUp() {
        validator = new StarlarkRuleValidator();
    }
    ...
    class ValidRules {
        ...
        void minimalRule_onTriggerOnly() {
            String rule = """
                    ...
                    """;
            String trigger = validator.validate(rule);
        ...
        void withForLoop() {
            String rule = """
                    ...
                    """;
            assertEquals("BatchInput", validator.validate(rule));
        }
        ...
        void withLocalVariables() {
            String rule = """
                    ...
                    """;
            assertEquals("SomeEvent", validator.validate(rule));
        }
        ...
        void withBuiltinFunctions() {
            String rule = """
                    ...
                    """;
            assertEquals("Input", validator.validate(rule));
        }
        ...
        void allSysMethods() {
            String rule = """
                    ...
                    sys.acquire("E", {})
                    """;
            assertEquals("Trigger", validator.validate(rule));
        }
    }
