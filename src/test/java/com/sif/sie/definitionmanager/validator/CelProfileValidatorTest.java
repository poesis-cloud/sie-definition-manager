...
class CelProfileValidatorTest {
        ...
        class GuardProfile {
                ...
                void singleAxisInequality_accepted() {
                        assertDoesNotThrow(() -> validator.validateGuard("PerformanceProperties.criticality >= 3"));
                }
                ...
                void singleAxisNegatedSetMembership_accepted() {
                        assertDoesNotThrow(() -> validator.validateGuard(
        ...
        class PredicateProfile {
                ...
                void emptyPredicate_rejected() {
                        assertThrows(IllegalArgumentException.class, () -> validator.validatePredicate(null));
                        assertThrows(IllegalArgumentException.class, () -> validator.validatePredicate(""));
                        assertThrows(IllegalArgumentException.class, () -> validator.validatePredicate("   "));
                }

                @Test
                void simpleThreshold_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("self.encryptionLevel >= \"AES-128\""));
                }

                @Test
                void booleanAnd_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate(
                ...
                void negation_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("!self.allowsAnonymousAccess"));
                }

                @Test
                void crossPropertyComparison_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("self.p99Latency < self.budget"));
                }

                @Test
                void arithmeticThreshold_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("self.p99Latency < self.budget * 1.1"));
                }
                ...
                void collectionMacroAll_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("self.ports.all(p, p >= 1024)"));
                }
                ...
                void hasFieldPresence_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("has(self.retentionPolicy)"));
                }

                @Test
                void sizeCheck_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("self.tags.size() >= 1"));
                }
                ...
                void typeConversion_accepted() {
                        assertDoesNotThrow(() -> validator.validatePredicate("double(self.monthlyBudget) > 0.0"));
                }
