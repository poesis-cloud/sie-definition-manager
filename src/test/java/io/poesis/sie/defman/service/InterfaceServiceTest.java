...
class InterfaceServiceTest {
    ...
    class RefereeReferences {
        ...
        void referencesStructureAndPorts() {
            ...
            var entity = mock(io.poesis.sie.defman.entity.InterfaceEntity.class);
    ...
    class CascadeRoles {
        ...
        void hasGoverningFromStructureAndDependentFromPorts() {
            ...
            assertTrue(roles.containsKey(
                    io.poesis.sie.defman.type.DefinitionSubjectType.STRUCTURE));
            assertTrue(roles.containsKey(
                    io.poesis.sie.defman.type.DefinitionSubjectType.EFFECTOR));
            assertTrue(roles.containsKey(
                    io.poesis.sie.defman.type.DefinitionSubjectType.RECEPTOR));

            assertTrue(roles.get(
                    io.poesis.sie.defman.type.DefinitionSubjectType.STRUCTURE) == io.poesis.sie.defman.type.AscriptionStatusTransitionCascadeType.GOVERNING);
            assertTrue(roles.get(
                    io.poesis.sie.defman.type.DefinitionSubjectType.EFFECTOR) == io.poesis.sie.defman.type.AscriptionStatusTransitionCascadeType.DEPENDENT);
            assertTrue(roles.get(
                    io.poesis.sie.defman.type.DefinitionSubjectType.RECEPTOR) == io.poesis.sie.defman.type.AscriptionStatusTransitionCascadeType.DEPENDENT);
        }
    }
