...
class AscriptionLifecycleServiceTest {
    ...
    @Mock
    private AbstractAscriptionService structureSubtype;

    @Mock
    private AbstractAscriptionService mechanismSubtype;
    ...
    class InvalidTransitions {
        ...
        void invalidTransition_rejected(String from, String to) {
            ...
            RuleType expectedRule = Set.of("RETIRED", "ABANDONED", "REJECTED").contains(from)
    ...
    /**
     * Stubs transitionService.recordTransition() to return a mock transition
     * entity.
     */
