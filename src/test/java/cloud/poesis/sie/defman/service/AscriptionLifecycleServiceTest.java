...
class AscriptionLifecycleServiceTest {
        ...
        class InvalidTransitions {
                ...
                void invalidTransition_rejected(String from, String to) {
                        ...
                        assertTrue(
                                        ...
                                        "Expected 'Invalid transition' or 'terminal state' but got: "
                                                        + ex.getMessage());
        ...
        class RefereePreconditions {
                ...
                void approvedToActive_refActive_allowed() {
                        ...
                        AscriptionEntity structureRef = stubEntity(
                                        UUID.randomUUID(), DefinitionSubjectType.STRUCTURE,
        ...
        class CascadeExecution {
                ...
                void governingCascade_propagatesTransition() {
                        ...
                        AscriptionEntity structure = stubEntity(
                                        structureId, DefinitionSubjectType.STRUCTURE, AscriptionStatusType.ACTIVE,
                                        defId);
        ...
        class DependentCascadeScope {
                ...
                void setUpDependentCascade() {
                        ...
                        AbstractAscriptionService<? extends AscriptionEntity> mechSvc = mock(
                                        AbstractAscriptionService.class);
                        ...
                        AbstractAscriptionService<? extends AscriptionEntity> structSvc = mock(
                                        AbstractAscriptionService.class);
