...
class AscriptionStatusTransitionServiceTest {
    ...
    @Mock
    private AbstractAscriptionService<? extends AscriptionEntity> structureSubtype;

    @Mock
    private AbstractAscriptionService<? extends AscriptionEntity> mechanismSubtype;
    ...
    class GetTransition {
        ...
        void returnsOptionalWhenFound() {
            ...
            Optional<AscriptionStatusTransitionEntity> result = service.getTransition(transitionId, ascriptionId);
    ...
    class PublicRefereePreconditions {
        ...
        void creationWithAllowedStatus_succeeds() {
            AscriptionEntity ref = stubEntity(
                    UUID.randomUUID(), DefinitionSubjectType.STRUCTURE, AscriptionStatusType.ACTIVE);
    ...
    class DependentCascadeScope {
        ...
        void setUpDependentCascade() {
            AbstractAscriptionService<? extends AscriptionEntity> mechSvc = mock(AbstractAscriptionService.class);
            ...
            AbstractAscriptionService<? extends AscriptionEntity> structSvc = mock(AbstractAscriptionService.class);
