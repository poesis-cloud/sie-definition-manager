...
class RuleViolationExceptionTest {
    ...
    class Constructors {
        ...
        void twoArgConstructor_setsMessageAndEmptySite() {
            var ex = new RuleViolationException(
        ...
        void threeArgConstructor_setsMessageAndSite() {
            ...
            var ex = new RuleViolationException(RuleType.ASCRIPTION_STATUS_TRANSITION_PATH, "bad path", site);
        ...
        void fourArgConstructor_setsMessageSiteAndCause() {
            ...
            var ex = new RuleViolationException(RuleType.NORM_GUARD_CEL_PARSING, "cel error", site, cause);
    ...
    class Getters {
        ...
        void getExtensions_mergesSiteAndRuleInfo() {
            ...
            var ex = new RuleViolationException(RuleType.ASCRIPTION_STATUS_TRANSITION_PATH, "detail", site);
    ...
    class StaticFactories {
        ...
        void of_buildsFromKeyValuePairs() {
            var ex = RuleViolationException.of(
