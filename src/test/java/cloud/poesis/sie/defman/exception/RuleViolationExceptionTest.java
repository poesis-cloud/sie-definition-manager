...
class RuleViolationExceptionTest {
  ...
  class Getters {
    ...
    void getType_delegatesToRuleType() {
      var ex =
          new RuleViolationException(
              AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH, "detail");
      assertEquals(
    ...
    void getTitle_delegatesToRuleType() {
      var ex =
          new RuleViolationException(
              AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH, "detail");
      assertEquals(
          AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH.getTitle(),
          ex.getTitle());
    }
    ...
    void getExtensions_mergesSiteAndRuleInfo() {
      ...
      var ex =
          new RuleViolationException(
              AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH, "detail", site);

      Map<String, Object> ext = ex.getExtensions();
      assertEquals("abc", ext.get("definitionId"));
      assertEquals(
          AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH.name(),
          ext.get("rule"));
      assertEquals(
          AscriptionStatusTransitionRuleType.ASCRIPTION_STATUS_TRANSITION_PATH.getDescription(),
          ext.get("ruleDescription"));
    }
    ...
    void getExtensions_emptySiteStillHasRuleInfo() {
      var ex =
          new RuleViolationException(
              AscriptionConsistencyRuleType.NORM_APPLICABILITY_CEL_PARSING, "detail");
      Map<String, Object> ext = ex.getExtensions();
  ...
  class StaticFactories {
    ...
    void of_emptyVarargs() {
      var ex =
          RuleViolationException.of(
              AscriptionConsistencyRuleType.NORM_APPLICABILITY_CEL_PARSING, "no site");
      assertTrue(ex.getSite().isEmpty());
    }
  }
  ...
  class SiteImmutability {
    ...
    void siteMapIsImmutable() {
      ...
      var ex =
          new RuleViolationException(
              AscriptionConsistencyRuleType.NORM_APPLICABILITY_CEL_PARSING, "detail", site);
