...
@ActiveProfiles("tc")
@Testcontainers
class VersionMaterializationIT {
    ...
    void duplicatePositiveVersionArchetypeIdIsRejected() {
        UUID typingArchetypeId = jdbc.queryForObject(
        ...
        String statement = "{\"$id\":\"gsmarc://test/ResolvableGuard/v1\",\"title\":\"ResolvableGuard\"}";
    ...
    void resolvableUriLookupKeepsOlderRetiredVersionReadableAndExcludesCandidate() {
        ...
        UUID versionOne = createDraftArchetype(
                definitionId,
                typingArchetypeId,
        ...
        UUID versionTwo = createDraftArchetype(
                definitionId,
                typingArchetypeId,
