...
class ArchetypeSeedRunnerTest {
  ...
  @Mock private cloud.poesis.sie.defman.service.ArchetypeService archetypeService;
    ...
    void reconcilesStemOwnersWhenArchetypesExist() throws Exception {
      ...
      when(jdbc.queryForList(
          ...
          .thenReturn(
              List.of(
                  Map.of(
                      "statement_id", "gsmarc://gsm/Structure/v1", "definition_id", definitionId)));
  ...
  class SeedInternal {
    ...
    void seedsMetaArchetypeAndOthers() throws Exception {
      ...
      JsonNode metaNode =
          realMapper.readTree("{\"$id\":\"gsmarc://gsm/Archetype/v1\",\"title\":\"Archetype\"}");
      JsonNode structNode =
          realMapper.readTree("{\"$id\":\"gsmarc://gsm/Structure/v1\",\"title\":\"Structure\"}");
  ...
  private void stubSchemasAndInserts() throws Exception {
    Resource metaResource =
        stubSchemaResource("{\"$id\":\"gsmarc://gsm/Archetype/v1\",\"title\":\"Archetype\"}");
