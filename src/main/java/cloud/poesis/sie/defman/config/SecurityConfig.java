 ...
 *
 * <p>Stateless, CSRF-disabled, JWT-based resource server. OpenAPI, actuator health/info, and API
 * endpoints are publicly accessible during design phase; all other paths require authentication.
 * OAuth 2 login is opt-in via {@code dm.security.oauth2-login-enabled}.
 *
