 ...
 *
 * <p>
 * Sourced from {@code gsm-ascription-lifecycle} state machine diagram. Replaces
 * inline lifecycle
...
public class AscriptionLifecycleService {
    ...
    private static final Set<AscriptionStatusType> IN_EFFECT = EnumSet.of(AscriptionStatusType.ACTIVE,
            AscriptionStatusType.DEPRECATED);
