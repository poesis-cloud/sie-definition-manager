...
final class PersistenceExceptionTranslationService {
  ...
  /**
   * Translates a direct Hibernate constraint violation raised by an explicit EntityManager flush.
   *
   * @param ex the Hibernate persistence exception
   * @return a domain exception for known constraints, or an {@link InternalException}
   */
