 ...
 *
 * <p>All fields are immutable after creation — assigned via constructor, no setters exposed. {@code
 * id} and {@code timestamp} are DB-generated via column defaults ({@code uuid_v7()} and {@code
 * clock_timestamp()}).
 *
 * <p>DB triggers on this table:
 *
 * <ul>
 *   <li>{@code tgf_assert_transition_ascription_exists} — BEFORE INSERT: validates that {@code
