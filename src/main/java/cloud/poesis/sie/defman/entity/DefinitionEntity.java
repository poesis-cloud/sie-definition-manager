 ...
 *
 * <p>
 * No triggers on this table. {@code id} is generated by the column default
 * {@code uuid_v7()}
...
public class DefinitionEntity {
   ...
   *
   * @param subjectType the GSM structural role of this subject (immutable once
   *                    assigned)
   */
  ...
  /**
   * Returns all Ascriptions referencing this Definition, ordered by timestamp
   * descending.
   *
