...
public abstract class AscriptionEntity {
  ...
  /**
   * Returns the governance version assigned when this Ascription reached APPROVED.
   *
   * @return {@code 0} before approval; otherwise the positive Definition-scoped version
   */
