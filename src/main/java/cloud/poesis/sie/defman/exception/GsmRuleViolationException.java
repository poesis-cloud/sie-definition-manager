 ...
 *
 * <p>
 * The {@link GsmRuleType} carries all semantic weight (which rule was
...
public class RuleViolationException extends RuntimeException {
     ...
     */
    public RuleViolationException(GsmRuleType ruleType, String detail, Map<String, Object> site, Throwable cause) {
        super(detail, cause);
        this.ruleType = ruleType;
        this.site = site != null ? Map.copyOf(site) : Map.of();
    }
     ...
     *
     * @return the {@link GsmRuleType} identifying the specific rule that was
     ...
     * @return a new {@code GsmRuleViolationException}
     * @throws IllegalArgumentException if the varargs array has odd length
     */
    public static RuleViolationException of(GsmRuleType ruleType, String detail,
