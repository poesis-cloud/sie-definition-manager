...
@Schema(name = "AscriptionStatusTransition", description = "Governance audit record of a lifecycle state change of an Ascription")
public class AscriptionStatusTransitionDto {
    ...
    public AscriptionStatusTransitionDto(UUID transitionId, UUID ascriptionId,
            AscriptionStatusType preStatus, AscriptionStatusType postStatus,
            Instant timestamp) {
