 ...
 *
 * <p>Definition and Archetype references are conveyed via HAL {@code _links}
 * ({@code up} for definition, {@code type} for archetype) rather than body
 * fields — the link relation carries the domain semantic.
 *
...
public class AscriptionDto {
    ...
    public AscriptionDto(UUID id, JsonNode statement, Instant timestamp,
            int version, AscriptionStatusType status) {
        this.id = id;
