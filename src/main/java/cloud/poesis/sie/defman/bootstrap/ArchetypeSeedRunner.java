...
/**
 * Seeds GSM base archetypes from {@code schemas/gsm-archetypes/*.schema.json} classpath resources
 * on first startup (idempotent — skips if archetypes already exist).
 *
 ...
 * INSERT time.
 *
 * <p>Schema files are sourced from {@code def/schemas/gsm-archetypes/} (mapped to classpath via
 * Maven resource directory). Single source of truth: edit schema files, restart — no migration
 * changes needed.
 *
