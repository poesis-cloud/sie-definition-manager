...
/**
 * Spring Data JPA repository for {@link MechanismEntity} (the {@code mechanism} table).
 *
...
public interface MechanismRepository extends AbstractAscriptionRepository<MechanismEntity> {
   ...
   */
  Page<MechanismEntity> findAllByStatusIn(
  ...
  /**
   * Returns mechanisms belonging to a structure definition filtered by lifecycle statuses.
   *
