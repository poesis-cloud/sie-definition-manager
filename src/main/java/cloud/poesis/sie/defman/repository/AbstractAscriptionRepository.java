 ...
 *
 * <p>
 * Declares the common query methods shared across all eight ascription
 * repositories (Structure, Mechanism, Archetype, Directive, Norm, Effector,
 * Receptor, Interaction). Concrete repositories extend this interface and
 * add subtype-specific query methods.
 *
...
public interface AbstractAscriptionRepository<T extends AscriptionEntity>
    ...
    List<T> findAllByDefinitionIdAndStatusIn(UUID definitionId, Collection<AscriptionStatusType> statuses);
}
