...
/**
 * Spring Data JPA repository for {@link ReceptorEntity} (the {@code receptor} table).
 *
...
public interface ReceptorRepository extends AbstractAscriptionRepository<ReceptorEntity> {
  ...
  /**
   * Returns receptors belonging to a mechanism definition filtered by lifecycle statuses.
   *
   * @param mechanismDefinitionId the mechanism definition UUID
