...
/**
 * Spring Data JPA repository for {@link AscriptionStatusTransitionEntity} (the {@code
...
public interface AscriptionStatusTransitionRepository
   ...
   */
  Optional<AscriptionStatusTransitionEntity> findByIdAndAscriptionId(UUID id, UUID ascriptionId);
}
