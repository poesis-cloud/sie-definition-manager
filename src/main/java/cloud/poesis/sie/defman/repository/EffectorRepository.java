...
/**
 * Spring Data JPA repository for {@link EffectorEntity} (the {@code effector} table).
 *
...
public interface EffectorRepository extends AbstractAscriptionRepository<EffectorEntity> {
  ...
  /**
   * Returns effectors belonging to a mechanism definition filtered by lifecycle statuses.
   *
   * @param mechanismDefinitionId the mechanism definition UUID
