...
/**
  ...
  *
  * <ul>
  *   <li>{@code revision_id} — generated by DB when NULL (V2 conditional trigger), or accepted from
  *       JPA when pre-set via {@link #ensureIds()}
  *   <li>{@code revision_timestamp} — always DB-authoritative
...
public abstract class AbstractAscription {
    ...
    void ensureIds() {
        if (revisionId == null) {
            revisionId = UuidV7Generator.generate();
        }
        if (id == null) {
