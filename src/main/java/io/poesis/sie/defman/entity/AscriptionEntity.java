 ...
 *
 * <ul>
 * <li>{@code id} (PK) — generated by Hibernate {@code @UuidGenerator} (UUIDv7),
 * or by DB default {@code uuid_v7()} when NULL (trigger safety net)
 ...
 * <ul>
 * <li>{@code id} — insertable (Hibernate generates via @UuidGenerator), not
 * updatable
