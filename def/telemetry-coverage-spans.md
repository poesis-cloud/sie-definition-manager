...
**Quantitative criterion (PRD-001 §4 / F-AC-8):** ≥95% of `required` units (denominator = non-AOP rows above) must have passing evidence. The AOP-covered span set is 100% structurally and is not part of the percentage denominator (the structural test green-light _is_ the evidence).
